...
SET(STM32_CHIP_TYPES 405xx 413xx 415xx 407xx 417xx 427xx 437xx 429xx 439xx 446xx 401xC 401xE 411xE CACHE INTERNAL "stm32f4 chip types")
SET(STM32_CODES "405.." "413.." "415.." "407.." "417.." "427.." "437.." "429.." "439.." "446.." "401.[CB]" "401.[ED]" "411.[CE]")

MACRO(STM32_GET_CHIP_TYPE CHIP CHIP_TYPE)
  STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](4[01234][135679].[BCEGHI]).*$" "\\1" STM32_CODE ${CHIP})
    SET(INDEX 0)
...
MACRO(STM32_GET_CHIP_PARAMETERS CHIP FLASH_SIZE RAM_SIZE CCRAM_SIZE)
  STRING(REGEX REPLACE "^[sS][tT][mM]32[fF](4[01234][135679].[BCEGHI]).*$" "\\1" STM32_CODE ${CHIP})
  STRING(REGEX REPLACE "^[sS][tT][mM]32[fF]4[01234][135679].([BCEGHI]).*$" "\\1" STM32_SIZE_CODE ${CHIP})
    ...
    ELSEIF(STM32_SIZE_CODE STREQUAL "G")
        SET(FLASH "1024K")
    ELSEIF(STM32_SIZE_CODE STREQUAL "H")
        SET(FLASH "1536K")
